...
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002589776901")) #Your db channel Id
OWNER = os.environ.get("OWNER", "moviesmansh") # Owner username without @
OWNER_ID = int(os.environ.get("OWNER_ID", "7862181538")) # Owner id
#--------------------------------------------
...
OWNER_TAG = os.environ.get("OWNER_TAG", "moviesmansh")
UPI_ID = os.environ.get("UPI_ID", "rohb@axl")
QR_PIC = os.environ.get("QR_PIC", "https://telegra.ph/file/3e83c69804826b3cba066-16cffa90cd682570da.jpg")
SCREENSHOT_URL = os.environ.get("SCREENSHOT_URL", f"t.me/rohit_188")
#--------------------------------------------
#Time and its price
#7 Days
